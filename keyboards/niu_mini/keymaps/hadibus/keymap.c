...
[_LOWER] = LAYOUT_planck_mit(
  ...
  _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, _______, KC_PSCR, _______, _______, _______,
...
/* Backlit
 * ,-----------------------------------------------------------------------------------.
 * |      |Plain |Breath|Rainbw|Swirl |      |      |      |      |Modes-|Modes+|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  TOG |Snake |Knight|X-Mas |Gradnt|      |      |      |      |Brigh-|Brigh+|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |Satur-|Satur+|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      | Hue- | Hue+ |      |
...
[_BACKLIT] = LAYOUT_planck_mit(
  _______, RGB_M_P,  RGB_M_B, RGB_M_R, RGB_M_SW, _______,  _______, _______, _______, RGB_RMOD, RGB_MOD,  _______,
  RGB_TOG, RGB_M_SN, RGB_M_K, RGB_M_X, RGB_M_G,  _______,  _______, _______, _______, RGB_VAD,  RGB_VAI,  _______,
